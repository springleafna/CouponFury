package com.springleaf.couponfury.merchant.admin.template;
...
public class CouponTemplateTest {
    ...
    public void testInsertCouponTemplate() {
        int affectedRows = couponTemplateMapper.saveCouponTemplate(buildCouponTemplateDO());
        boolean saved = affectedRows > 0;
        Assert.isTrue(saved);
    }
}

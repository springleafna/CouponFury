package com.springleaf.couponfury.merchant.admin.template.spel;

import cn.hutool.core.lang.Assert;
import com.springleaf.couponfury.merchant.admin.common.context.UserContext;
import com.springleaf.couponfury.merchant.admin.common.context.UserInfoDTO;
...
public class CouponTemplateLogSpELTests {
    ...
    public void testSpELGetCurrentUser() {
        ...
        // 调用用户上下文获取当前用户 ID
        String spELKey = "T(com.springleaf.couponfury.merchant.admin.common.context.UserContext).getUserId()";
        ExpressionParser parser = new SpelExpressionParser();
        Expression expression = parser.parseExpression(spELKey);
        try {
    ...
    public void testSpELGetCurrentUserDefaultValue() {
        ...
        String spELKey = "T(com.springleaf.couponfury.merchant.admin.common.context.UserContext).getUserId() ?: 'haha'";
        ExpressionParser parser = new SpelExpressionParser();
        Expression expression = parser.parseExpression(spELKey);
